...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 3b739b33-ffdb-49e3-aa5f-56854c42cbab
```

> `3b739b33-ffdb-49e3-aa5f-56854c42cbab` is the password of the certificate, you can change it to any password you want.
