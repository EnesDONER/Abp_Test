...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p cd2a753c-b0c8-4dbe-9323-1a2329792280
```

> `cd2a753c-b0c8-4dbe-9323-1a2329792280` is the password of the certificate, you can change it to any password you want.
