...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p aeb95c12-f636-4d5f-973d-ec90f6c3a33c
```

> `aeb95c12-f636-4d5f-973d-ec90f6c3a33c` is the password of the certificate, you can change it to any password you want.
